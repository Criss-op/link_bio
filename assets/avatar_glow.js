(() => {
   ...
   function setVars(clientX, clientY) {
      ...
      const outX = clientX < r.left ? r.left - clientX : clientX > r.right ? clientX - r.right : 0;
      const outY = clientY < r.top ? r.top - clientY : clientY > r.bottom ? clientY - r.bottom : 0;
   ...
   window.addEventListener("pointermove", (e) => schedule(e.clientX, e.clientY), { passive: true });
